...
private:
	...
	int _playerSelectNum = 0;						//플레이어 선택 번호
	int _itemSelectNum = 0;							//아이템 선택 번호
	int _magicSelectNum = 0;						//마법 선택 번호
	...
	bool _enemySelect = false;						//에너미 선택
	bool _playerSelect = false;						//플레이어 선택
	bool _itemSelect = false;						//아이템 선택
