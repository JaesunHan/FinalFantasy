...
battleLocke::battleLocke()
{
	...
	_partyIdx = 0;
	//얼굴 이미지 
	_faceImg = IMAGEMANAGER->addImage("lockeFace", "./image/playerImg/locke/locke_face.bmp", 56, 38, true, RGB(0, 0, 255));

	//================================ Start 각 상태에 따른 이미지와 애니메이션을 기본값으로 초기화 ===========================================
	_idleImg = IMAGEMANAGER->addFrameImage("lockeIdle", "./image/playerImg/locke/locke_idle.bmp", 186, 192, 3, 3, true, RGB(0, 0, 255));
	...
	//공격 이미지, 애니메이션
	_atkImg = IMAGEMANAGER->addFrameImage("lockeAttack", "./image/playerImg/locke/locke_atk.bmp", 459, 828, 3, 9, true, RGB(0, 0, 255));
	...
	_atkAnim->setFPS(1);
	//공격 대기 이미지, 애니메이션
	_atkStandbyImg = IMAGEMANAGER->addFrameImage("lockeAttackStandby", "./image/playerImg/locke/locke_atk_standby.bmp", 198, 171, 3, 3, true, RGB(0, 0, 255));
	...
	//마법 공격 이미지, 애니메이션
	_magicAtkImg = IMAGEMANAGER->addFrameImage("lockeMagicAttack", "./image/playerImg/locke/locke_magic_atk.bmp", 204, 252, 3, 3, true, RGB(0, 0, 255));
	...
	//마법 공격 대기 이미지, 애니메이션
	_magicAtkStandbyImg = IMAGEMANAGER->addFrameImage("lockeMagicAttackStandby", "./image/playerImg/locke/locke_magic_atk_standby.bmp", 186, 213, 3, 3, true, RGB(0, 0, 255));
	...
	_deadImg = IMAGEMANAGER->addFrameImage("lockeDead", "./image/playerImg/locke/locke_dead.bmp", 118, 54, 2, 1, true, RGB(0, 0, 255));
	...
	_winImg = IMAGEMANAGER->addFrameImage("lockeWin", "./image/playerImg/locke/locke_win.bmp", 174, 201, 3, 3, true, RGB(0, 0, 255));
	...
	_winAnim->setPlayFrame(winArr,89, true);
	_winAnim->setFPS(1);

	_winBeforeImg = IMAGEMANAGER->addFrameImage("lockeWinBefore", "./image/playerImg/locke/locke_win_before.bmp", 228, 480, 3, 6, true, RGB(0, 0, 255));
	...
	int winBeforeArr[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
	_winBeforeAnim->setPlayFrame(winArr, 89, true);
