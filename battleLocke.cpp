...
battleLocke::battleLocke()
{
	...
	tmpMagic->init("Locke::fire Magic1", "./image/playerImg/playerEffectImage/playerSkill4.bmp", "파이어 볼!", 21, 4, 150, 0);
	...
	tmpMagic->init("Locke::fire Magic2", "./image/playerImg/playerEffectImage/playerSkill3.bmp", "화염 폭발!", 60, 45, 150, 0);
	_myUsableMagic.push_back(tmpMagic);
}
