...
void Enemy::setItemDropRate(int num1, int num2, int num3, int num4, int num5, int num6, int num7, int num8, int num9, int num10, int num11)
{
	...
	tagDROPITEM temp;
	temp.dropRate = num1;
	wsprintf(temp.itemName, "메가엘릭서");
	_vItemDropRate.push_back(temp);
	temp.dropRate = num2;
	wsprintf(temp.itemName, "엘릭서");
	_vItemDropRate.push_back(temp);
	temp.dropRate = num3;
	wsprintf(temp.itemName, "에테르");
	_vItemDropRate.push_back(temp);
	temp.dropRate = num4;
	wsprintf(temp.itemName, "육포");
	_vItemDropRate.push_back(temp);
	temp.dropRate = num5;
	wsprintf(temp.itemName, "토닉");
	_vItemDropRate.push_back(temp);
	temp.dropRate = num6;
	wsprintf(temp.itemName, "포션");
	_vItemDropRate.push_back(temp);
	temp.dropRate = num7;
	wsprintf(temp.itemName, "침낭");
	_vItemDropRate.push_back(temp);
	temp.dropRate = num8;
